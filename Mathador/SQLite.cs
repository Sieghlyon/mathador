...
namespace Mathador
{
    public class SQLite
    {
        ...
        public static void creer_BDD()
        {
            ...
            string sql = "CREATE TABLE IF NOT EXISTS highscore (pseudo, score, nombre_calcul)";
        ...
        public static void write(string pseudo, int score, int nbr_c)
        {
            SQLiteConnection connexion;
            connexion = new SQLiteConnection("Data Source = BDD.sqlite; Version=3;");
            connexion.Open();

            string sql = "INSERT INTO highscore VALUES (@pseudo, @score, @nombre_calcul)";
